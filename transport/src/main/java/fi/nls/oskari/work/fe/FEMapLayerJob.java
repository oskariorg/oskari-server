...
import fi.nls.oskari.work.fe.FEQueryArgsBuilder;
import fi.nls.oskari.work.fe.FERequestTemplate;
import fi.nls.oskari.work.fe.FESetup;
import fi.nls.oskari.work.fe.FEUrl;
...
public class FEMapLayerJob extends OWSMapLayerJob {
    ...
    public FEMapLayerJob(TransportService service, Type type,
    ...
    public void run() {
        ...
        if (!this.layerPermission) {
            ...
            this.service.send(session.getClient(),
    ...
    protected void sendWFSFeature(List<Object> values) {
        ...
        this.service.send(this.session.getClient(),

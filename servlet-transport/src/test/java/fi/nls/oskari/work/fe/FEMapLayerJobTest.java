...
public class FEMapLayerJobTest {
    ...
    private static final String layerJSON = "{\"selectedFeatureParams\":{},\"jobType\":\"oskari-feature-engine\",\"getMapTiles\":true,\"layerName\":\"ELF_GN_nls_fi\",\"featureElement\":\"NamedPlace\",\"getHighlightImage\":true,\"templateType\":\"mah taip\",\"GMLGeometryProperty\":\"geom\",\"geometryNamespaceURI\":\"\",\"featureType\":{\"default\":\"*geometry:Geometry,text:String,script:String,sourceOfName:String,nameStatus:String,nativeness:String,language:String,beginLifespanVersion:String,endLifespanVersion:String,localType:String\"},\"tileBuffer\":{\"default\":1,\"oskari_custom\":1},\"maxFeatures\":5000,\"maxScale\":1,\"URL\":\"!http://visukarttake01.nls.fi:8080/elf-wfs/services/elf-lod1gn|http://195.156.69.59/elf-wfs/services/elf-lod1gn\",\"requestTemplate\":\"/fi/nls/oskari/fe/input/format/gml/inspire/gn/nls_fi_wfs_template.xml\",\"isPublished\":false,\"featureParamsLocales\":{},\"getFeatureInfo\":true,\"tileRequest\":false,\"styles\":{\"2\":{\"SLDStyle\":\"/fi/nls/oskari/fe/output/style/inspire/gn/nls_fi.xml\",\"id\":\"2\",\"name\":\"oskari-feature-engine\"}},\"layerId\":\"4\",\"WFSVersion\":\"2.0.0\",\"responseTemplate\":\"/fi/nls/oskari/fe/input/format/gml/gn/ELF_generic_GN.groovy\",\"GML2Separator\":false,\"minScale\":120000,\"featureNamespace\":\"elf-lod1gn\",\"SRSName\":\"urn:ogc:def:crs:EPSG::3857\",\"GMLVersion\":\"3.2.1\",\"featureNamespaceURI\":\"http://www.locationframework.eu/schemas/GeographicalNames/MasterLoD1/1.0\",\"templateDescription\":\"ELF GN PoC\",\"templateName\":\"ELF GN\",\"uiName\":\"GN Geographical Names - nls.fi\",\"geometryType\":\"2d\"}";

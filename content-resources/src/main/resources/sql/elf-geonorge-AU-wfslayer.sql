...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_AU_geonorge_no', 902, 
         500000, 1, 
         'http://wfs.geonorge.no/skwms1/wfs.elf-lod1au', null, null, 'urn:ogc:def:crs:EPSG::3857', '2.0.0',  '{fi:{name:"AU Administrative Units - geonorge.no", subtitle:""},sv:{name:"AU Administrative Units - geonorge.no", subtitle:""},en:{name:"AU Administrative Units - geonorge.no", subtitle:""}}');
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://wfs.geonorge.no/skwms1/wfs.elf-lod1au+elf_AU_geonorge_no');

-- ELF AU cuzk.cz - requires username, password
-- add map layer; 
INSERT INTO oskari_maplayer(type, name, groupId, 
                            minscale, maxscale, 
                            url, username, password, srs_name,version,
                            locale) 
  VALUES('wfslayer', 'elf_AU_cuzk_cz', 903, 
         500000, 1, 
          'http://services.cuzk.cz/wfs/inspire-au-wfs.asp', null, null,'urn:ogc:def:crs:EPSG::3857', '2.0.0',
           '{fi:{name:"AU Administrative Units - cuzk.cz", subtitle:""},sv:{name:"AU Administrative Units  - cuzk.cz", subtitle:""},en:{name:"AU Administrative Units - cuzk.cz", subtitle:""}}');
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://services.cuzk.cz/wfs/inspire-au-wfs.asp+elf_AU_cuzk_cz');

...
INSERT INTO oskari_maplayer(type, name, groupId,
                            ...
                            tile_matrix_set_id,
                            minScale, maxScale)
  VALUES('wmtslayer', 'kiinteistotunnukset', (SELECT MAX(id) FROM oskari_layergroup),
...
UPDATE oskari_maplayer SET tile_matrix_set_data='{
      ...
      "layers": [
          {
              ...
              "layers": [],
              "title": "kiinteistotunnukset",
              "identifier": "kiinteistotunnukset",
              "resourceUrl": {
                  "tile": {
                      "format": "image/png",
                      "template": "http://karttamoottori.maanmittauslaitos.fi/kiinteisto/wmts/1.0.0/kiinteistotunnukset/default/{TileMatrixSet}/{TileMatrix}/{TileRow}/{TileCol}.png",
                      "resourceType": "tile"
                  }
              },
              "resourceUrls": [
  ...
  "version": "1.0.0"
}' WHERE type='wmtslayer' AND name='kiinteistotunnukset' AND url='http://karttamoottori.maanmittauslaitos.fi/kiinteisto/wmts';

...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_HY_fgi_fi', 906, 
         500000, 1, 
          'http://inspire-hy.fgi.fi/geoserver/wfs', null, null,  'urn:ogc:def:crs:EPSG::3857', '2.0.0',
          '{fi:{name:"HY Hydrography - fgi.fi", subtitle:""},sv:{name:"HY Hydrography - fgi.fi", subtitle:""},en:{name:"HY Hydrography - fgi.fi", subtitle:""}}');
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://inspire-hy.fgi.fi/geoserver/wfs+elf_HY_fgi_fi');

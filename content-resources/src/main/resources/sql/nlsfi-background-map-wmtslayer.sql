...
INSERT INTO oskari_maplayer(type, name, groupId,
                            ...
                            locale,
                            tile_matrix_set_id)
  VALUES('wmtslayer', 'taustakartta', (SELECT MAX(id) FROM oskari_layergroup),
...
UPDATE oskari_maplayer SET tile_matrix_set_data='{
  ...
  "version": "1.0.0"
}' WHERE type='wmtslayer' AND name='taustakartta' AND url='http://karttamoottori.maanmittauslaitos.fi/maasto/wmts';

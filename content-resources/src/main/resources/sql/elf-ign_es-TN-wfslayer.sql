...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_tn_ign_es', 901, 
         120000, 1, 
         'wfs', '{fi:{name:"TN Road Link - ign.es", subtitle:""},sv:{name:"TN Road Link - ign.es", subtitle:""},en:{name:"TN Road Link - ign.es", subtitle:""}}');
...
INSERT INTO portti_wfs_layer ( 
    ...
    VALUES ( (select max(id) from oskari_maplayer), 
      'ELF_TN_ign_es', 
       'http://www.ign.es/wfs-inspire/transportes-btn100', null, null, 
       'geom', '3.2.1', false, 
       '2.0.0', 5000, 
       'elf_lod1rtn', 
       '', 
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfs+elf_tn_ign_es');

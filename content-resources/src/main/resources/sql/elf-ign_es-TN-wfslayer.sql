...
INSERT INTO oskari_maplayer(type, name, groupId, 
                            ...
                            locale) 
  VALUES('wfslayer', 'elf_tn_ign_es', 901, 
         120000, 1, 
          'http://www.ign.es/wfs-inspire/transportes-btn100', null, null,  'EPSG:900913', '2.0.0', '{fi:{name:"TN Road Link - ign.es", subtitle:""},sv:{name:"TN Road Link - ign.es", subtitle:""},en:{name:"TN Road Link - ign.es", subtitle:""}}');
...
VALUES (
    ...
    '/fi/nls/oskari/fe/input/format/gml/inspire/tn/ign_es_wfs_template.xml', 
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://www.ign.es/wfs-inspire/transportes-btn100+elf_tn_ign_es');

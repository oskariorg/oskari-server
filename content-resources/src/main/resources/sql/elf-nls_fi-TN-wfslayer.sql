...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_tn_nlsfi', 905, 
         120000, 1, 
         'wfs', '{fi:{name:"TN Road Link - nls.fi", subtitle:""},sv:{name:"TN Road Link - nls.fi", subtitle:""},en:{name:"TN Road Link - nls.fi", subtitle:""}}');
...
INSERT INTO portti_wfs_layer ( 
    ...
    VALUES ( (select max(id) from oskari_maplayer), 
      'ELF_TN_nls_fi', 
       'http://elf-wfs.maanmittauslaitos.fi/elf-wfs/services/elf-lod1rdtn', null, null, 
       'geom', '3.2.1', false, 
       '2.0.0', 5000, 
       'elf_lod1rtn', 
       '', 
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfs+elf_tn_nlsfi');

-- ELF GN lantmateriet.se - requires username, password
-- add map layer; 
INSERT INTO oskari_maplayer(type, name, groupId, 
                            minscale, maxscale, 
                            url, username, password, srs_name, version,
                            locale) 
  VALUES('wfslayer', 'elf_gn_lantmateriet', 904, 
         120000, 1, 
         'http://download-ver.lantmateriet.se/elf/v1.0/wfs/gn', '', '', 'urn:ogc:def:crs:EPSG::3857', '2.0.0',
         '{fi:{name:"GN Geographical Names - lm.se", subtitle:""},sv:{name:"GN Geographical Names - lm.se", subtitle:""},en:{name:"GN Geographical Names - lm.se", subtitle:""}}');
...
VALUES (
	...
	'/fi/nls/oskari/fe/input/format/gml/inspire/gn/lantmateriet_wfs_template.xml', 
...
INSERT INTO portti_wfs_layer_style (name,sld_style) VALUES(
	...
	'/fi/nls/oskari/fe/output/style/inspire/gn/lantmateriet.xml'
);
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://download-ver.lantmateriet.se/elf/v1.0/wfs/gn+elf_gn_lantmateriet');

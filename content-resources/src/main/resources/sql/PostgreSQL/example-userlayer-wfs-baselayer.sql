  ...
  selection_sld_style_id, get_map_tiles, get_feature_info, tile_request, wms_layer_id, srs_name, feature_element, feature_namespace_uri, geometry_namespace_uri,
   get_highlight_image, wps_params, tile_buffer)
    VALUES ((select id from oskari_maplayer where name = 'oskari:vuser_layer_data'),
     'oskari:vuser_layer_data', 'http://localhost:8084/geoserver/oskari/ows', 'admin', 'geoserver', 'geometry', '3.1.1', false, '1.1.0', 2000, 'oskari', NULL, NULL, '{}',
      '{}', '{}',
       '2d', NULL, false, true, false, NULL, 'EPSG:3067', 'vuser_layer_data', 'http://www.oskari.org', '', true, '{}', '{}');

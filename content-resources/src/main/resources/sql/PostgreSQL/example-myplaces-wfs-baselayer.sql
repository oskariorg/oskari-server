...
INSERT INTO oskari_maplayer(type, name, groupId,
  ...
  VALUES('wfslayer', 'oskari:my_places', (SELECT MAX(id) FROM oskari_layergroup),
  		 15000000, 1, 
         50, 'http://localhost:8084/geoserver/oskari/ows', 'admin', 'geoserver', '1.1.0', 'EPSG:3067', '{ fi:{name:"Omat paikat",subtitle:""},sv:{name:"My places",subtitle:""},en:{name:"My places",subtitle:""}}');

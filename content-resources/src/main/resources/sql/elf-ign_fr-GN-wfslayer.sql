...
INSERT INTO oskari_maplayer(type, name, groupId, 
  ...
  VALUES('wfslayer', 'elf_gn_ignfr', (SELECT MAX(id) FROM oskari_layergroup), 
         120000, 1, 
         'http://wxs.ign.fr/6veobt10ttujyzlu605byvhv/inspire/wfs', NULL, NULL, 'urn:ogc:def:crs:EPSG::3857', '2.0.0',
         '{fi:{name:"ELF GN - ign.fr", subtitle:""},sv:{name:"ELF GN - ign.fr", subtitle:""},en:{name:"ELF GN - ign.fr", subtitle:""}}');
...
INSERT INTO portti_wfs_layer_style (name,sld_style) VALUES(
	...
	'/fi/nls/oskari/fe/output/style/inspire/gn/ign_fr.xml'
);
...
INSERT INTO oskari_resource(resource_type, resource_mapping) values ('maplayer', 'wfslayer+http://wxs.ign.fr/6veobt10ttujyzlu605byvhv/inspire/wfs+elf_gn_ignfr');

 ...
 * - year -> year
 */
public class V1_45_8__migrate_user_indicator_data implements JdbcMigration {

    private static final Logger LOG = LogFactory.getLogger(V1_45_8__migrate_user_indicator_data.class);
    ...
    private static boolean migrateData(Connection conn, UserIndicator indicator) throws SQLException {
        ...
        // from [{"region":"488","primary value":"23"}...] to [{"region":"488","value":"23"}...]
        return true;
    }

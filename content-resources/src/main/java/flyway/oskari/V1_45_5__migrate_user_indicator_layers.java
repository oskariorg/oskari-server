...
public class V1_45_5__migrate_user_indicator_layers implements JdbcMigration {

    private static final Logger LOG = LogFactory.getLogger(V1_45_5__migrate_user_indicator_layers.class);

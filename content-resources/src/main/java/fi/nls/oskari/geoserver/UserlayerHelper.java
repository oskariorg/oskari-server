...
public class UserlayerHelper {
    ...
    public static final String MODULE_NAME = "userlayer";

    private static final Logger LOG = LogFactory.getLogger(UserlayerHelper.class);

    public static void setupUserlayers(final String srs)
            throws Exception {

...
public class ResponseHelper {
    ...
    private static final byte[] NOT_IMPLEMENTED = "Not implemented!".getBytes(StandardCharsets.US_ASCII);
    ...
    public static void notImplemented(HttpServletResponse resp) {
        write(resp, HttpServletResponse.SC_NOT_IMPLEMENTED, PLAIN_TEXT, NOT_IMPLEMENTED);
    }

    public static void notImplemented(HttpServletResponse resp, String msg) {
        byte[] body = msg != null ? msg.getBytes(StandardCharsets.UTF_8) : NOT_IMPLEMENTED;
        write(resp, HttpServletResponse.SC_NOT_IMPLEMENTED, PLAIN_TEXT, body);
    }

...
public class WKTHelperTest {
    ...
    public void testTransform() throws Exception {
        ...
        assertEquals(6672130.96106858, transformed.getCoordinate().y, 1e-9);
        assertEquals(385615.37435276626, transformed.getCoordinate().x, 1e-9);
    }
    ...
    public void testCoverageTransform() throws Exception {
        ...
        for (int i = 0; i < transformedCoordinates.length; i++) {
            assertEquals(expectedCoordinates[i].x, transformedCoordinates[i].x, 1e-8);
            assertEquals(expectedCoordinates[i].y, transformedCoordinates[i].y, 1e-8);
        }
    }

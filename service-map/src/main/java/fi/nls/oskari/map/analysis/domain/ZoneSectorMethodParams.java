...
public class ZoneSectorMethodParams extends AnalysisMethodParams {
    ...
    private final String analysisMethodTemplate = "analysis-layer-wps-zone.xml";
    private final String analysisMethodTemplate2 = "analysis2analysis-layer-wps-zone.xml";
    private final String analysisMethodTemplate3 = "analysis2geojson-layer-wps-zone.xml";
    ...
    public Document getWPSXML() throws XPathExpressionException, IOException,
        ...
        this.setLiteralDataContent(doc, ZONE_COUNT, this.getZone_count());

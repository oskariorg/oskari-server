...
public class GetFeaturesXmlParser {
	...
	try {
	    ...
	    featureJson.put("feature_fi", featureType.getWfsTitleFi());
	    featureJson.put("feature_en", featureType.getWfsTitleEn());
	    featureJson.put("feature_sv", featureType.getWfsTitleSv());

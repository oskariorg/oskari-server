...
public class SpatineoMonitoringDaoTest {
    ...
    public void testIntegration() {
        final String url = "https://beta.spatineo-devops.com/api/public/monitoringAPI?privateAccessKey=15pN_55SIjytRwZIuXG4DT75euT6FXrsXmsXg7LPOexkt0EYgtndew&includeAllMeters=true";
        final SpatineoMonitoringDao dao = new SpatineoMonitoringDao(url, new HttpClient(), false);
        SpatineoMonitoringResponseDto dto = dao.checkServiceStatus();
        System.err.println("dto = " + dto);
        if (dto != null) System.err.println("dto = " + dto.toString());
    }
}

...
public class WfsXmlParserTest {
    ...
    public void testParseKuntaRegions() throws IOException {
        InputStream is = new ByteArrayInputStream(testResponseKunta.getBytes());
        List<RegionCodeNamePair> result = WfsXmlParser.parse(is, "kuntakoodi", "kuntanimi");
    ...
    public void testParseSeutukuntaRegions() throws IOException {
        InputStream is = new ByteArrayInputStream(testResponseSeutukunta.getBytes());
        List<RegionCodeNamePair> result = WfsXmlParser.parse(is, "seutukuntanro", "seutukunta");
    ...
    public void testParseSeutukuntaRegionsWithWrongProps() throws IOException {
        InputStream is = new ByteArrayInputStream(testResponseSeutukunta.getBytes());
        List<RegionCodeNamePair> result = WfsXmlParser.parse(is, "asdf", "qwer");

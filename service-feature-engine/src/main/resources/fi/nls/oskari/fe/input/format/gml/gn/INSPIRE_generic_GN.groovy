...
public class INSPIRE_generic_GN_Parser extends AbstractGroovyGMLParserRecipe.GML32 {

    def input_ns = "urn:x-inspire:specification:gmlas:GeographicalNames:3.0";
    ...
    def output_ns = "urn:x-inspire:specification:gmlas:GeographicalNames:3.0#";

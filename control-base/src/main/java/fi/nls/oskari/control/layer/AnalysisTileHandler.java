 ...
 */
@OskariActionRoute("AnalysisTile")
public class AnalysisTileHandler extends ActionHandler {

    private final static Logger log = LogFactory.getLogger(AnalysisTileHandler.class);

    final private static String SERVICE_KEY = "analysistile";

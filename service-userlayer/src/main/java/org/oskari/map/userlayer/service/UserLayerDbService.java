...
public abstract class UserLayerDbService extends OskariComponent {
    ...
    //UserLayer related
    public abstract int insertUserLayer(final UserLayer userlayer, final UserDataStyle userLayerStyle, final List<UserLayerData> userLayerDataList) throws UserLayerException;

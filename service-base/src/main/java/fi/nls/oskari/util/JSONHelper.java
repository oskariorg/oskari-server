...
public class JSONHelper {
    ...
    public static final JSONObject createJSONObject(final String content) {
        try {
            ...
            throw new IllegalArgumentException("Could create JSONObject for " + content );
        }
    }
    ...
    public static final JSONObject getJSONObject(final JSONObject content, String key) {
        try {
            ...
            throw new IllegalArgumentException("Could create JSONObject for " + content + "by key = " + key);
        }
    }
    public static final JSONArray getJSONArray(final JSONObject content, String key) {
        try {
            ...
            throw new IllegalArgumentException("Could create JSONArray for " + content + "by key = " + key);
        }
    }
	...
	public static JSONArray createJSONArray(final String content) {
        try {
            ...
            throw new IllegalArgumentException("Could create JSONArray for " + content );
        }
	}

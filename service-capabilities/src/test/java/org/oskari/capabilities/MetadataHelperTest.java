...
public class MetadataHelperTest {
	...
	public static void setup() throws Exception {
		...
		PropertyUtil.addProperty("service.metadata.url", "http://www.mydomain2.org", true);
	}
	...
	public void testIsDomainAllowed() {
		List<String> allowedDomains = Arrays.asList(new String[]{"paikkatietohakemisto.fi", "mydomain.org"});

...
public class RYSP_kanta_Rakennus {
    ...
    public static class _osoitenimi {
    ...
    public static class A_1_rakennuksenosat {
        public static final String NS = "http://www.paikkatietopalvelu.fi/gml/kantakartta";
        ...
        @XmlElement(required = false)
        public java.util.List<featureMember> featureMember = new java.util.ArrayList<featureMember>();

        @JacksonXmlProperty(namespace = "http://www.opengis.net/gml", localName = "featureMember")
        public void setFeatureMember(final featureMember obj) {
            if (obj != null) {
    ...
    public static class RakennuksenOsa {
        public static final String NS = "http://www.paikkatietopalvelu.fi/gml/kantakartta";

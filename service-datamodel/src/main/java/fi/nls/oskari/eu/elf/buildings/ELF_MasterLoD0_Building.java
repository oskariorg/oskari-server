...
public class ELF_MasterLoD0_Building
{
   ...
   public static class Building
   {
      ...
      private java.util.List<BuildingPart> parts = new java.util.ArrayList<BuildingPart>();
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getBuildingNature()
      {
      ...
      @JsonGetter
      public java.util.List<CurrentUse> getCurrentUse()
      {
         return currentUse;
      }
      ...
      @XmlElement(required = false)
      public void setParts(final java.util.List<BuildingPart> list)
      {
         if (list != null)
         {
            parts.addAll(list);
      ...
      @JsonGetter
      public java.util.List<BuildingPart> getParts()
      {
         return parts;
      }
      ...
      @JsonGetter
      public java.util.List<FloorRange> getFloorDistribution()
      {
      ...
      @JsonGetter
      public java.util.List<FloorDescription> getFloorDescription()
      {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getRoofType()
      {
         return roofType;
      }
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getMaterialOfFacade()
      {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getMaterialOfRoof()
      {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getMaterialOfStructure()
      {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getHeatingSource()
      {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getHeatingSystem()
      {
      ...
      @JsonGetter
      public java.util.List<AddressRepresentation> getAddress()
      {
         return address;
      }
      ...
      @JsonGetter
      public java.util.List<OfficialArea> getOfficialArea()
      {
         return officialArea;
      }
      ...
      @JsonGetter
      public java.util.List<OfficialValue> getOfficialValue()
      {
      ...
      @JsonGetter
      public java.util.List<AddressRepresentation> getMixinaddress()
      {
         return mixinaddress;
      }
      ...
      @JsonGetter
      public java.util.List<CadastralParcel> getCadastralParcel()
      {
   ...
   public static class FloorDescription
   {
      ...
      @JsonGetter
      public java.util.List<fi.nls.oskari.fe.xml.util.Reference> getCurrentUse()
      {
         return currentUse;
      }
      ...
      @JsonGetter
      public java.util.List<FloorRange> getFloorRange()
      {
         return floorRange;
      }
   }
   ...
   public static class EnergyPerformance
   {
      ...
      @XmlElement(required = false)
      public List<DocumentCitation> assessmentMethod;
   }
   ...
   public static class DocumentCitation
   {
      ...
      @JsonGetter
      public java.util.List<java.net.URI> getLink()
      {
         return link;
      }
      ...
      @JsonGetter
      public java.util.List<java.lang.String> getSpecificReference()
      {
   ...
   public static class AddressRepresentation
   {
      ...
      @JsonGetter
      public java.util.List<GeographicalName> getAdminUnit()
      {
         return adminUnit;
      }
      ...
      @JsonGetter
      public java.util.List<java.lang.String> getLocatorDesignator()
      {
      ...
      @JsonGetter
      public java.util.List<GeographicalName> getLocatorName()
      {
         return locatorName;
      }
      ...
      @JsonGetter
      public java.util.List<GeographicalName> getAddressArea()
      {
         return addressArea;
      }
      ...
      @JsonGetter
      public java.util.List<GeographicalName> getPostName()
      {
         return postName;
      }
      ...
      @JsonGetter
      public java.util.List<GeographicalName> getThoroughfare()
      {
         return thoroughfare;
      }
   }

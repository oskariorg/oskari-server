 ...
 */
public class ELF_MasterLoD0_Address_nls_fi_wfs
{
   ...
   public static class Address extends Nillable
   {
      ...
      @XmlElement(required = false)
      public java.util.List<Reference> parcel = new java.util.ArrayList<Reference>();
      @XmlElement(required = false)
      ...
      public void setParcel(final Reference obj)
      {
         if (obj != null)
         {
            parcel.add(obj);
      ...
      java.util.List<Reference> getParcel()
      {
         return parcel;
      }

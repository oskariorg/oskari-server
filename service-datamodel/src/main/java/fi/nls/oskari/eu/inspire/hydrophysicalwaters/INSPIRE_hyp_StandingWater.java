...
- timestamp Wed Dec 17 12:39:45 EET 2014
 */
public class INSPIRE_hyp_StandingWater
{

   public static final String TIMESTAMP = "Wed Dec 17 12:39:45 EET 2014";
   ...
   public static class StandingWater extends Nillable
   {
      public static final String NS = "urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0";
      public static final QName QN = new QName(NS, "StandingWater");
      ...
      @JacksonXmlProperty(namespace = "urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0", localName = "elevation")
      @XmlElement(required = false)
      public NillableType<String> elevation;
      @JacksonXmlProperty(namespace = "urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0", localName = "meanDepth")
      @XmlElement(required = false)
      public NillableType<String> meanDepth;
      @JacksonXmlProperty(namespace = "urn:x-inspire:specification:gmlas:HydroPhysicalWaters:3.0", localName = "surfaceArea")
      @XmlElement(required = false)
      public NillableType<String> surfaceArea;
